    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link navbar-navy">
                ...
                <span class="brand-text font-weight-light">DUNITEC</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="imagenes/userdefault.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><%=request.getSession().getAttribute("nombre")%></a>
                           <a href="#" class="d-block">Agente De Registro</a>
                    </div>
                </div>
        ...
        <%
            String panel = "panel_nuevo_usuario.jsp";
